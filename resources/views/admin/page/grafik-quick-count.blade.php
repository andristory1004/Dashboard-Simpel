<x-admin-layout>
    ...
    <div class="bg-blue">
        <div class="flex items-center justify-between px-5 py-3 bg-green rounded-tl-3xl">
            <h1 class="text-2xl font-bold text-black md:text-3xl lg:text-3xl font-oswald">Grafik Quick Count</h1>
        </div>
    </div>
    <div class="w-auto p-3 space-x-10 space-y-5 md:flex md:space-x-0">
        ...
        <div class="text-center md:mx-5 md:w-4/12">
            <h1 class="font-bold font-oswald">Grafik Real Count <br> Agustus 2022</h1>
            <div class="container">
