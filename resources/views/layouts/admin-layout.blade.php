            ...
            <div class="flex flex-wrap items-center">
                ...
                <div class="flex w-full pt-2 content-center justify-between md:w-1/3 md:justify-end">
                    <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                        ...
                        <li class="flex-1 md:flex-none md:mr-3">
                            <a class="active:text-red-900 inline-block text-gray-400 no-underline hover:text-gray-200 hover:text-underline py-2 px-4"
                                href="#">link</a>
                        </li>
                        <li class="flex-1 md:flex-none md:mr-3">
            ...
            <nav aria-label="alternative nav">
                <div
                    ...
                    <div
                        ...
                        <ul
                            class="navbar-nav list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                            {{-- <li class="mr-3 flex-1 {{set_active('analisis')}}">
                                <a href={{route('dashboard')}} class="nav-link block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-blue-600">
                                    <i class="fas fa-chart-network pr-0 md:pr-3 text-blue-600"></i>
                            ...
                            <li class="mr-3 flex-1">
                                <a href={{route('dashboard')}}
                                    ...
                                    <i class="fas fa-carrot pr-0 md:pr-3"></i>
                                    <span
                            ...
                            <li class="mr-3 flex-1">
                                <a href={{route('relawan')}}
                                    ...
                                    <i class="fas fa-tasks pr-0 md:pr-3"></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Relawan</span>
                                </a>
                            </li>
                            <li class="mr-3 flex-1">
                                <a href="{{ route('analisis') }}"
                                    class="block active:text-red-600 py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                                    <i class="fa fa-envelope pr-0 md:pr-3"></i><span
                                        class="nav-link pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Analisis</span>
                                </a>
                            </li>
                            <li class="mr-3 flex-1">
                                <a href="#"
                                    ...
                                    <i class="fa fa-wallet pr-0 md:pr-3"></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Info</span>
                                </a>
                            </li>
                        </ul>
                    </div>
